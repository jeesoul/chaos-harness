---
description: Generate Harness constraints, Iron Laws, anti-bypass rules
---
...
```bash
find ~/.claude/plugins/cache/chaos-harness -name "SKILL.md" -path "*/harness-generator/*" 2>/dev/null | head -1
```
