---
description: Java code style checking for Spring Boot projects
---
...
```bash
find ~/.claude/plugins/cache/chaos-harness -name "SKILL.md" -path "*/java-checkstyle/*" 2>/dev/null | head -1
```
