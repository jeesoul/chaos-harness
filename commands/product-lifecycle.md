---
description: Product lifecycle management - from requirements to release, complete RPLACEHOLDER_DESCD workflow with self-learning
---
...
```bash
find ~/.claude/plugins/cache/chaos-harness -name "SKILL.md" -path "*/product-lifecycle/*" 2>/dev/null | head -1
```
