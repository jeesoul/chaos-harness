---
description: Self-learning analyzer - failure pattern detection, iron law optimization suggestions, closed-loop iteration
---
...
```bash
find ~/.claude/plugins/cache/chaos-harness -name "SKILL.md" -path "*/learning-analyzer/*" 2>/dev/null | head -1
```
