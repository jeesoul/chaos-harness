---
description: Agent Team 编排器 - 自动调度多 Agent 并行工作、监督执行、鞭策偷懒
---
...
```bash
find ~/.claude/plugins/cache/chaos-harness -name "SKILL.md" -path "*/agent-team-orchestrator/*" 2>/dev/null | head -1
```
