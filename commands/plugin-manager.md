---
description: Manage plugins, configure extensions, custom Iron Laws
---
...
```bash
find ~/.claude/plugins/cache/chaos-harness -name "SKILL.md" -path "*/plugin-manager/*" 2>/dev/null | head -1
```
